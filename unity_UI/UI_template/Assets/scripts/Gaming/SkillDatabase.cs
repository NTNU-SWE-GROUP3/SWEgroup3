...
public class SkillDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        SkillList.Add(new PlayerSkill(1,"時間限縮","此回合縮短對手選牌時間5秒",Resources.Load<Sprite>(SkillImagesPath+"SKillTime")));
        ...
        SkillList.Add(new PlayerSkill(9,"強制徵收","對手贏牌區張數-1",Resources.Load<Sprite>(SkillImagesPath + "SkillEarn1")));
        SkillList.Add(new PlayerSkill(10,"勝者之堆","我方贏牌區張數+1",Resources.Load<Sprite>(SkillImagesPath+ "SkillMin1")));//路徑可改
